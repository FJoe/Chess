...
public class Board
{
	...
	void morphPawn(Piece pawn, String morphTo)
	{
		if(morphTo.endsWith("N"))
			board[pawn.y][pawn.x] = new Knight(pawn.color, pawn.x, pawn.y, this);
		else if(morphTo.endsWith("R"))
			board[pawn.y][pawn.x] = new Rook(pawn.color, pawn.x, pawn.y, this);
		else if(morphTo.endsWith("B"))
			board[pawn.y][pawn.x] = new Bishop(pawn.color, pawn.x, pawn.y, this);
		else if(morphTo.endsWith("p"))
			;
		else
		{

			board[pawn.y][pawn.x] = new Queen(pawn.color, pawn.x, pawn.y, this);
		}
	}
}
